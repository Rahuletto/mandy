...
export interface InsomniaAuthentication {
    type: "none" | "basic" | "bearer" | "apikey" | "oauth1" | "oauth2" | "hawk" | "digest" | "ntlm" | "aws-iam";
    token?: string;
    username?: string;
    password?: string;
    key?: string;
...
export type InsomniaResourceType = InsomniaWorkspace | InsomniaRequestGroup | InsomniaRequest | InsomniaEnvironment | InsomniaCookieJar;
