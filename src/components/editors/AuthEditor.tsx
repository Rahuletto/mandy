        ...
        <div className="space-y-4">
            ...
            "Basic" in authValue && (
              <>
                <div className="space-y-1.5">
                  <label className="text-[10px] font-medium text-white/30 px-1">
                    Username
                  </label>
                  <EnvInput
          ...
          {method === "ApiKey" &&
            ...
            "ApiKey" in authValue && (
              <>
                <div className="space-y-1.5">
                  <label className="text-[10px] font-bold text-white/30 px-1">
                    Key
                  </label>
                  <EnvInput
                        ...
                        className={`flex-1 px-3 py-2 rounded-lg text-xs font-medium transition-all border ${
                          authValue.ApiKey.add_to === loc
                            ...
                            : "bg-white/5 border-white/5 text-white/40" +
                              (!disabled
                                ? " hover:text-white/60 hover:bg-white/10"
                                : "")
  ...
  return (
    <div className="flex flex-col h-full overflow-hidden">
      <div className="flex items-center gap-4 px-4 py-3 border-b border-white/5 shrink-0">
        <div className="text-xs text-white/30">Authorization</div>
        ...
        <div className="relative">
          <button
            ...
            className={`flex items-center gap-2 px-3 py-1 rounded-full transition-all text-xs font-medium ${
