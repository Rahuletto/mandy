...
import type { Methods, ResponseRenderer, ApiResponse } from "../../bindings";
...
>(function RestRequestEditor(
  ...
  const [showCurlOverwriteDialog, setShowCurlOverwriteDialog] =
    useState(false);
    ...
    <>
      <div className="flex gap-4 border-b border-text/15 p-4">
        ...
        >
          ...
          <MethodSelector value={activeRequest.request.method} onChange={updateMethod} />
                  ...
                  onChange={(items) => {
                    ...
                    Object.keys(activeRequest.request.cookies).forEach(
                      (idx) => {
                        ...
                        if (
                          !newCookies.find((c) => c.name === oldCookie.name)
                        ) {
          ...
          <div className="bg-card rounded-xl p-5 w-full max-w-xl border border-border">
            ...
            <div className="flex justify-end gap-3 mt-4">
              ...
              <button
                ...
                className="px-4 py-2 text-sm bg-accent hover:bg-accent/90 rounded-lg transition-colors"
              >
                Import
              </button>
            </div>
