...
export function NewProjectModal({
    ...
    const [selectedSource, setSelectedSource] = useState<NewProjectSource | null>(null);
    ...
    const sources = [
        { id: "blank" as NewProjectSource, label: "Blank Project", icon: TbPlus, color: "text-accent" },
        { id: "postman" as NewProjectSource, label: "Import from Postman", icon: SiPostman, color: "text-orange-400" },
        { id: "insomnia" as NewProjectSource, label: "Import from Insomnia", icon: SiInsomnia, color: "text-purple-400" },
    ];
                ...
                <div className="flex items-center justify-between px-4 py-3 border-b border-white/5">
                    ...
                    <div className="flex-1 text-center">
                        <h2 className="text-sm font-semibold text-white">
                            {selectedSource === "blank" ? "New Project" : selectedSource ? "Import Project" : "New Project"}
                        </h2>
                    </div>
                    <button
                        onClick={handleClose}
                ...
                {!selectedSource ? (
                    ...
                    <div className="p-4 space-y-4">
                        ...
                        <button
                            ...
                            disabled={loading || (selectedSource === "blank" ? !projectName.trim() : !fileContent)}
                        ...
                        >
                            {loading ? (
                                ...
                                <span>{selectedSource === "blank" ? "Create Project" : "Import Project"}</span>
                            )}
                        </button>
                    </div>
                )}
