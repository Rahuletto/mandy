...
function ToastItem({ toast, onRemove }: { toast: any; onRemove: () => void }) {
    ...
    const getIcon = (type: ToastType) => {
        switch (type) {
            case "success": return <BiCheckCircle className="text-green-400" size={18} />;
            case "error": return <BiErrorCircle className="text-red-400" size={18} />;
            default: return <BiInfoCircle className="text-blue-400" size={18} />;
        }
    };
