          ...
          <div className="max-w-3xl">
            ...
            <section className="flex flex-col gap-8">
              {requestNodes.length > 0 && (
                <div className="mt-4">
                  <h3 className="text-sm font-semibold text-white/70 mb-2">Requests</h3>
              ...
              {conditionNodes.length > 0 && (
                <div>
                  <h3 className="text-sm font-semibold text-white/70 mb-2">Conditions</h3>
                  <div className="space-y-1">
              ...
              {loopNodes.length > 0 && (
                <div>
                  <h3 className="text-sm font-semibold text-white/70 mb-2">Loops</h3>
                  <div className="space-y-1">
                    {loopNodes.map((node) => {
