	...
	if (data.type === "request") {
		...
		return (
			<div className="flex items-center gap-2 min-w-0">
				<span
					className={`text-[10px] font-mono font-bold px-1.5 py-0.5 rounded shrink-0 ${getMethodColor(req.method)}`}
				>
					{req.method || "GET"}
				</span>
						...
						<div key={step.node.id}>
							...
							<div className="flex gap-2 ml-1">
								<div className="flex-1 rounded-md border border-green/15 bg-green/[0.02] px-2 pt-1.5 pb-1 min-w-0">
									<p className="text-[10px] font-semibold text-green/50 mb-0.5">
										true
									</p>
								...
								<div className="flex-1 rounded-md border border-red/15 bg-red/[0.02] px-2 pt-1.5 pb-1 min-w-0">
									<p className="text-[10px] font-semibold text-red/50 mb-0.5">
										false
									</p>
					...
					<div key={step.node.id}>
						...
						<div className="rounded-lg border border-violet-500/20 bg-violet-500/[0.03] px-3 pt-2 pb-1 ml-1">
							...
							{step.body.length > 0 ? (
								...
								<p className="text-[11px] text-white/20 py-2 ml-2">
									No body steps
								</p>
							)}
						</div>
											...
											return (
												...
												>
													<div className="flex items-center gap-3">
														<span
															className={`text-[10px] font-mono font-bold px-1.5 py-0.5 rounded ${getMethodColor(data.method)}`}
														>
															{data.method || "GET"}
														</span>
