...
import type { Project, Folder, RequestItem, TreeItem } from "../types/project";
...
function normalizeRoot(root: Folder): Folder {
  return {
    ...root,
    children: root.children.map((c) => normalizeTreeItem(c) as Folder | RequestItem),
  };
}
 ...
 */
export function migrateProjectWithBackupSteps(project: Project): MigrateProjectResult {
